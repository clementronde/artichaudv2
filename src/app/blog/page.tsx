...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://artichaud-studio.com/blog',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://artichaud-studio.com/blog'
  }
};
...
export default function BlogIndex() {
  ...
  return (
    <>
      <main className="w-full bg-white pt-40 pb-20 min-h-screen">
        <div className="container mx-auto px-6 md:px-12">
          <h1 className="text-[40px] md:text-[60px] leading-[1.1] font-normal text-arti-black mb-16">
            Conseils Création de Site Web,<br/> Branding & Stratégie Digitale
          </h1>
      ...
      <RelatedLinks
        title="Transformer un guide en action"
